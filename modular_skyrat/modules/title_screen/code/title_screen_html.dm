...
/mob/dead/new_player/proc/get_title_html()
	...
	if(SSticker.current_state == GAME_STATE_STARTUP)
		...
		if(!SSticker || SSticker.current_state <= GAME_STATE_PREGAME)
			...
			dat += {"
				<a class="menu_button" href='?src=[text_ref(src)];late_join=1'>Enter Wasteland</a>
				<a class="menu_button" href='?src=[text_ref(src)];view_manifest=1'>Active Manifest</a>
			"}
			//BUBBER EDIT ADDITION: CHARACTER DIRECTORY
			dat += {"<a class="menu_button" href='?src=[text_ref(src)];character_directory=1'>Directory</a>"}
			//BUBBER EDIT ADDITION END

		dat += {"<a class="menu_button" href='?src=[text_ref(src)];observe=1'>Observe Round</a>"}

		dat += {"
			<a class="menu_button" href='?src=[text_ref(src)];character_setup=1'>(<span id="character_slot">[uppertext(client.prefs.read_preference(/datum/preference/name/real_name))]</span>)</a>
